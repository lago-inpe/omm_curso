...
plt.suptitle("Furacão Julia (2022). Água Precipitável (mm), Vento em 850 hPa e Omega (Pa/s) em 500 hPa", fontsize=15, y=0.95)
plt.savefig("furacao_julia_previsao_ap_omega_vento.png", dpi=300, bbox_inches='tight')
plt.close()
print("✅ Figura salva como furacao_julia_previsao_ap_omega_vento.png")
